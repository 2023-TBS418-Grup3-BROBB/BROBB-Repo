...
<body>
    ...
    <nav class="navbar navbar-expand-lg d-flex">
        <div class="container-fluid">
            ...
            <form class="justify-content-end login">
                <button type="button" class="btn btn-info" onclick="location.href='login.php'"><i
    ...
    <div class="container">
        <form method="POST" action="registerUser.php">
            ...
            <div class="card">
                <div class="card-header giris">Kayıt Ol</div>
                <div class="card-body form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="col-sm-10 submit">
                            <br><br>
                            <a href="#" class="a">Hizmet Şartlarını Okudum Kabul Ediyorum</a> <input type="checkbox"
                                class="form-check-input" id="exampleCheck1">
                            <br>
                            <a href="#" class="a">Reklam sözleşmesini okudum kabul ediyorum</a> <input type="checkbox"
                                class="form-check-input" id="exampleCheck1">
                        </div>
                        <br><br>
                        <button type="submit" class="btn btn-info login-btn" id="register-button"> Kayıt Ol</button>
                    </div>
                </div>
        </form>
    </div>
